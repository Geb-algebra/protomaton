...
// services for this domain as self-documented pure functions
...
//  */
// export const ExampleService = (input: ExampleInput): ExampleOutput => {
// 	 return ExampleOutput.create(input);
// };
